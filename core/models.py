...
class DnCNN(nn.Module):
    def __init__(self, channels, num_of_layers=17, output_type='linear', inplace_type = True, bn = True):
...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=3, output_activation = 'linear'):
        """Initializes U-Net."""
